...
class TechnicalAnalyzer:
    ...
    def load_historical_data(self, crypto_id):
        filename = f"data/historical/{crypto_id}_historical.csv"
        ...
        for record in df.to_dict("records"):
            clean_record = {k: (None if (v is None or (isinstance(v, float) and math.isnan(v))) else v)
